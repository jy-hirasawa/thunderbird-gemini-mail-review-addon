...
[English](../en/I18N.md) | 日本語 | [Deutsch](../de/I18N.md) | [Français](../fr/I18N.md) | [简体中文](../zh_CN/I18N.md) | [Italiano](../it/I18N.md)
...
- **英語（en）** - デフォルト言語
- **日本語（ja）** - 日本語対応
- **ドイツ語（de）** - Deutsch-Unterstützung
- **フランス語（fr）** - Support français
- **簡体字中国語（zh_CN）** - 简体中文支持
...
│   └── messages.json    # 日本語翻訳
├── de/
│   └── messages.json    # ドイツ語翻訳
├── fr/
│   └── messages.json    # フランス語翻訳
└── zh_CN/
    └── messages.json    # 簡体字中国語翻訳
```
